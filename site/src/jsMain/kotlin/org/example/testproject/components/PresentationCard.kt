...
import org.example.testproject.styles.PresentationStyle
...
//            )
        ...
        P(
            ...
            Text("Formado em Ciência da Computação pela Universidade Federal do Ceará (UFC). Tenho experiência na construção de aplicações Back-end e Mobile. Aliado a minha experiência, foco no momento em construir aplicações utilizando tecnologias de desenvolvimento nativo.")
        }
    }
}
